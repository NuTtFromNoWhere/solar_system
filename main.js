...
document.getElementById("start").onclick = (e) => {
  ...
  document.getElementById("lockshit").style.display = "none"
...
var onAnimate = true;
window.lateestobject = null;

function fitCameraToObject(object) {
  if (window.lateestobject){
    document.getElementById(window.lateestobject).style.display = "none";
    window.lateestobject = null;
  }
  window.lateestobject = object.name;
  onAnimate = false;
  FitCam = true;
  ...
  function animateCamera(time) {
    ...
    if (progress < 1) {
      ...
      var popup = document.getElementById(object.name);
...
var pointLight = new THREE.PointLight(0xffffff, 1, 2100);
